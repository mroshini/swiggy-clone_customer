...
class SearchFoodItemBottomSheetScreen extends StatefulWidget {
  ...
  SearchFoodItemBottomSheetScreen(
      {this.imageSrc,
      this.nameOfDish,
      this.description,
      this.price,
  ...
  @override
  _SearchFoodItemBottomSheetScreenState createState() =>
      _SearchFoodItemBottomSheetScreenState();
}

class _SearchFoodItemBottomSheetScreenState
    extends State<SearchFoodItemBottomSheetScreen> {
  var cartActionModel;

  @override
  Widget build(BuildContext context) {
    cartActionModel = Provider.of<SearchViewModel>(context, listen: false);
    return Container(
